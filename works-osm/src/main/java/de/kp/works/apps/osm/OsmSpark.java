...
/**
 * [OsmSpark] is a wrapper class for the [OsmReactor]
 */
public class OsmSpark extends AbstractSpark {

    public static final String NAME = "OsmReactor";
    public static final String DESC = "This Spark program executes geo-centric analytics" +
            " based on Open Street Map.";

    OsmApp.OsmConfig config;

    public OsmSpark(OsmApp.OsmConfig config) {
        this.config = config;
    }
    ...
    protected void configure() {
         ...
         * available for the [OsmReactor]
         */
        this.setProperties(getProperties());
        /*
         * Connect the Spark program with the [OsmReactor]
         */
        this.setMainClass(OsmReactor.class);
        this.setMainClassName(OsmReactor.class.getName());
    }
    /**
